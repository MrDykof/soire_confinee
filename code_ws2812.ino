...
#define LED_PIN   7  //Pin for the pixel strand. Does not have to be analog.
#define LED_TOTAL 7  //Change this to the number of LEDs in your strand.
...
void setup() {    //Like it's named, this gets ran before any other function.
  ...
  Serial.begin(19200); //Sets data rate for serial data transmission. base is 9600
